...
impl Action {
    pub fn from_keybind_name(s: &str) -> Option<Self> {
        ...
        match normalized.as_str() {
            ...
            "toggle_issues_view" | "issues_view" | "issues" => Some(Self::ToggleIssuesView),
            "open_review_view" | "review_view" | "review" => Some(Self::OpenReviewView),
            "open_projects_view" | "projects_view" | "projects" => Some(Self::OpenProjectsView),
            "open_journal_view" | "journal_view" | "journal" => Some(Self::OpenJournalView),
            "archive_completed" => Some(Self::ArchiveCompleted),
            "arm_f" => Some(Self::ArmF),
            "arm_z" => Some(Self::ArmZ),
            "open_dispatch_draft" | "dispatch_draft" | "dispatch" => Some(Self::OpenDispatchDraft),
